            ...
            NavigationView {
                VStack {
                    ...
                    ScrollView {
                        ...
                        //hero image
                        KFImage.url(URL(string:"https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")).resizable().scaledToFill().frame(height: 200).cornerRadius(1)
